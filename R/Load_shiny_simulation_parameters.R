...
### Add the 1st trait, oligogenic and non correlated to other traits
SP.avocado$addTraitA(nQtlPerChr = 2, name = "Width",
                     mean = 8, var = 2)
...
traitcor.avocado <- matrix(c(1,0.2,0.2,1), ncol = 2, byrow = T)
SP.avocado$addTraitA(nQtlPerChr = 2, name = c("Height", "PitSize"),
                     mean = c(10, 5), var = c(3, 2), corA = traitcor.avocado)
...
### Add the 1st trait, oligogenic and non correlated to other traits
traitcor.strawberry <- matrix(c(1,0.2,0.2, 1), ncol = 2, byrow = T)
SP.strawberry$addTraitA(nQtlPerChr = 4, name = c("Height", "Width"),
...
### Adding two negatively correlated traits
SP.strawberry$addTraitA(nQtlPerChr = 2, name = "SeedSize", mean = 5, var = 1.5)
